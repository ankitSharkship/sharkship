...
import '../../domain/entity/ndr_order_entity.dart';

class NdrOrderModel extends NdrOrderEntity {
  NdrOrderModel({
    required super.id,
    super.externalId,
    ...
    required super.ndrReasons,
  });

  factory NdrOrderModel.fromJson(Map<String, dynamic> json) {
    return NdrOrderModel(
      id: json['id'] ?? 0,
      ...
      productPrice: json['product_price'] is num ? json['product_price'] as num : 0,
      ...
      shippingCharge: json['shipping_charge'] is String
          ? num.tryParse(json['shipping_charge']) ?? 0
          : (json['shipping_charge'] is num ? json['shipping_charge'] as num : 0),
      ...
      ndrCount: json['ndrCount'] ?? 0,
      ndrReasons: List<String>.from(json['ndrReasons'] ?? []),
    );
  }
}
