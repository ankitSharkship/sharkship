...
//         ElevatedFormCard(
//           title: 'Import Bulk Orders',
//           child: Column(
//             children: [
//               const SizedBox(height: 10),
//               const Text(
//                 'Upload a spreadsheet (Excel or CSV) with order details to create orders in bulk.',
...
//                 subtitle: 'Refer to this template for mandatory fields.',
//                 color: Colors.blue.shade50,
//                 iconColor: Colors.blue,
//                 onTap: () => notifier.downloadTemplate(),
//               ),
...
//                 title: state.file != null
//                     ? 'File Selected'
//                     : 'Select Spreadsheet',
//                 subtitle: state.file != null
//                     ? state.file!.path.split('/').last
//                     : 'Attach your .xlsx or .csv file here.',
//                 color: state.file != null
//                     ? Colors.green.shade50
//                     : Colors.orange.shade50,
//                 iconColor: state.file != null ? Colors.green : Colors.orange,
//                 onTap: () => notifier.pickFile(),
//                 onTrailingTap: state.file != null
//                     ? () => notifier.clearFile()
//                     : null,
//               ),
...
//                     ),
//                   ),
//                   onPressed: state.file == null || state.isLoading
//                       ? null
//                       : () async {
//                           final success = await notifier.submit();
//                           if (success && mounted) {
//                             _showSuccessDialog(isBulk: true);
//                           }
//                         },
...
//   void _showSuccessDialog({bool isBulk = false}) {
//     showDialog(
//       context: context,
...
//             const SizedBox(height: 24),
//             Text(
//               isBulk ? 'Bulk Upload Successful!' : 'Order Created!',
//               style: const TextStyle(fontSize: 22, fontWeight: FontWeight.bold),
//             ),
//             const SizedBox(height: 12),
//             Text(
//               isBulk
//                   ? 'Your spreadsheet has been uploaded and orders are being processed.'
